...
from medical_diffusion.models.utils.attention_blocks import MedfusionAttention, PerceiverResampler, zero_module, AttentionPooling
...
class UNet(nn.Module):
    def __init__(self, 
        ...
        self.cond_projection_linear = nn.Linear(cond_emb_hidden_dim, self.time_embedder.emb_dim, bias=False)
        self.cond_act = nn.SiLU()
        self.cond_projection_linear2 = nn.Linear(self.time_embedder.emb_dim, self.time_embedder.emb_dim, bias=False)
    ...
    def forward(self, x_t, t=None, condition_embed=None, condition_mask=None, self_cond=None):
        ...
        if condition_embed is None:
            ...
            #cond_emb = self.cond_projection_linear3(condition_embed)
        # ---------- Self-conditioning-----------
